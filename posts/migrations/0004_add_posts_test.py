...
class Migration(migrations.Migration):
    ...
    def generate_post_test_data(apps, schema_editor):
        ...
        resume =  Resume(users[0], "Hi this is my resume file :) " + users[0].first_name),
        ...
        with transaction.atomic():
            resume =  Resume(author=users[0], description= "Hi this is my resume file :) " + users[0].first_name, resume_file = "files/Alon_Shakaroffs_resume.pdf" )
            resume.save()
            r = range(2,5)
            for i in r:
